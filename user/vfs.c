...
EMBED_ACTION_DESCRIPTOR (OUTPUT, NO_PARAMETER, 0, register_request, VFS_REGISTER_REQUEST, "", "");
...
EMBED_ACTION_DESCRIPTOR (INPUT, NO_PARAMETER, AUTO_MAP, register_response, VFS_REGISTER_RESPONSE, "", "");
